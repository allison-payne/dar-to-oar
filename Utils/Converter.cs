...
namespace oar_explorer.Utils
{
    internal static class Converter
    {
        ...
        public static PluginValue GetPluginValue(string condition)
        {
        ...
        public static KeywordValue GetKeywordValue(string condition)
        {
        ...
        public static Condition parseCondition(string condition, bool isNegated = false)
        {
        ...
        public static async Task<DirectoryInfo> GenerateMainConfigFile(DirectoryInfo darActorFolder, DirectoryInfo oarModFolder, string oarConfigPath, string? modName, string? author = "")
        {

            ProjectConfig mc = new ProjectConfig()
            {
                author = author,
        ...
        public static async Task<DirectoryInfo> BuildOARDirectory(DirectoryInfo darActorFolder, DirectoryInfo oarModFolder, string oarConfigPath, bool overwrite, string? modName, string? modAuthor)
        {
        ...
        public static async Task<List<DirectoryInfo>> BuildOARDirectories(DirectoryInfo oarModFolder, string darModFolder, bool overwrite, string? modName, string? modAuthor)
        {
        ...
        public static async void GenerateSubmodConfigFile(FileInfo conditionsFile)
        {
            // TODO: Add some better error handling here.
            int priority = conditionsFile.Directory != null ? int.Parse(conditionsFile.Directory.Name) : 0;
            ...
            SubmodConfig config = new SubmodConfig()
            {
                name = name,
                priority = priority,
        ...
        public static void ConvertConditions(List<DirectoryInfo> oarConditionsFolders)
        {
            foreach (DirectoryInfo directory in oarConditionsFolders)
            {
                ...
                {
                    GenerateSubmodConfigFile(conditionsFile);
                }
            }
        }
